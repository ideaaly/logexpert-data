<template>
  <app-layout title="Dashboard">
    <div
        ...
        <div v-if="$page.props.appointment"> <inventory-card-component :g_event_id="$page.props.appointment.g_event_id" :data="data"></inventory-card-component> </div>
        <div v-else> <inventory-card-component :data="data"></inventory-card-component> </div>
