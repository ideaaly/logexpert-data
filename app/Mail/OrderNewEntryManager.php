...
class OrderNewEntryManager extends Mailable
{
    ...
    {
        return $this->view('emails.orderNewEntryManager')->with([
            ...
            'type' => $this->type
        ])->subject('[Commande ELE] Informations sur l\'état des lieux d\'entrée');
    }
}
